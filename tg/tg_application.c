...
void tg_application_start()
{
    ...
    tg_mesh_h mesh_h = TG_NULL;
    tg_vertex_shader_h vertex_shader_h = TG_NULL;
    tg_fragment_shader_h fragment_shader_h = TG_NULL;
    tg_material_h material_h = TG_NULL;
    tg_model_h model_h = TG_NULL;

    tg_graphics_mesh_create(4, positions, normals, uvs, TG_NULL, 6, indices, &mesh_h);
    ...
    tg_mesh_h mesh2_h = TG_NULL;
    tg_material_h material2_h = TG_NULL;
    tg_model_h model2_h = TG_NULL;

    tg_graphics_mesh_create(3, positions2, TG_NULL, uvs2, tangents, 0, TG_NULL, &mesh2_h);
    ...
    tg_mesh_h ground_mesh_h = TG_NULL;
    tg_material_h ground_material_h = TG_NULL;
    tg_model_h ground_model_h = TG_NULL;

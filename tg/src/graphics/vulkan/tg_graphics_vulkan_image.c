...
tg_color_image_h tgg_color_image_load(const char* p_filename)
{
    ...
    *color_image_h = tgg_vulkan_color_image_create(&vulkan_color_image_create_info);
    ...
    tgg_vulkan_command_buffer_cmd_transition_color_image_layout(command_buffer, color_image_h, 0, 0, VK_IMAGE_LAYOUT_UNDEFINED, VK_IMAGE_LAYOUT_TRANSFER_DST_OPTIMAL, VK_PIPELINE_STAGE_TOP_OF_PIPE_BIT, VK_PIPELINE_STAGE_TOP_OF_PIPE_BIT);
    tgg_vulkan_command_buffer_cmd_copy_buffer_to_color_image(command_buffer, staging_buffer.buffer, color_image_h);
    tgg_vulkan_command_buffer_cmd_transition_color_image_layout(command_buffer, color_image_h, 0, 0, VK_IMAGE_LAYOUT_TRANSFER_DST_OPTIMAL, TG_VULKAN_COLOR_IMAGE_LAYOUT, VK_PIPELINE_STAGE_TOP_OF_PIPE_BIT, VK_PIPELINE_STAGE_TOP_OF_PIPE_BIT);
...
tg_color_image_h tgg_color_image_create(const tg_color_image_create_info* p_color_image_create_info)
{
    ...
    tg_vulkan_color_image_create_info vulkan_color_image_create_info = { 0 };
    {
        ...
        vulkan_color_image_create_info.format = tgg_vulkan_color_image_convert_format(p_color_image_create_info->format);
        vulkan_color_image_create_info.min_filter = tgg_vulkan_image_convert_filter(p_color_image_create_info->min_filter);
        vulkan_color_image_create_info.mag_filter = tgg_vulkan_image_convert_filter(p_color_image_create_info->mag_filter);
        vulkan_color_image_create_info.address_mode_u = tgg_vulkan_image_convert_address_mode(p_color_image_create_info->address_mode_u);
        vulkan_color_image_create_info.address_mode_v = tgg_vulkan_image_convert_address_mode(p_color_image_create_info->address_mode_v);
        vulkan_color_image_create_info.address_mode_w = tgg_vulkan_image_convert_address_mode(p_color_image_create_info->address_mode_w);
    }
    *color_image_h = tgg_vulkan_color_image_create(&vulkan_color_image_create_info);

    VkCommandBuffer command_buffer = tgg_vulkan_command_buffer_allocate(graphics_command_pool, VK_COMMAND_BUFFER_LEVEL_PRIMARY);
    tgg_vulkan_command_buffer_begin(command_buffer, VK_COMMAND_BUFFER_USAGE_ONE_TIME_SUBMIT_BIT, TG_NULL);
    tgg_vulkan_command_buffer_cmd_transition_color_image_layout(command_buffer, color_image_h, 0, 0, VK_IMAGE_LAYOUT_UNDEFINED, TG_VULKAN_COLOR_IMAGE_LAYOUT, VK_PIPELINE_STAGE_TOP_OF_PIPE_BIT, VK_PIPELINE_STAGE_TOP_OF_PIPE_BIT);
    tgg_vulkan_command_buffer_end_and_submit(command_buffer, &graphics_queue);
    tgg_vulkan_command_buffer_free(graphics_command_pool, command_buffer);
...
void tgg_color_image_destroy(tg_color_image_h color_image_h)
{
    ...
    tgg_vulkan_color_image_destroy(color_image_h);
...
tg_depth_image_h tgg_depth_image_create(const tg_depth_image_create_info* p_depth_image_create_info)
{
    ...
    tg_vulkan_depth_image_create_info vulkan_depth_image_create_info = { 0 };
    {
        ...
        vulkan_depth_image_create_info.format = tgg_vulkan_depth_image_convert_format(p_depth_image_create_info->format);
        vulkan_depth_image_create_info.min_filter = tgg_vulkan_image_convert_filter(p_depth_image_create_info->min_filter);
        vulkan_depth_image_create_info.mag_filter = tgg_vulkan_image_convert_filter(p_depth_image_create_info->mag_filter);
        vulkan_depth_image_create_info.address_mode_u = tgg_vulkan_image_convert_address_mode(p_depth_image_create_info->address_mode_u);
        vulkan_depth_image_create_info.address_mode_v = tgg_vulkan_image_convert_address_mode(p_depth_image_create_info->address_mode_v);
        vulkan_depth_image_create_info.address_mode_w = tgg_vulkan_image_convert_address_mode(p_depth_image_create_info->address_mode_w);
    }
    *depth_image_h = tgg_vulkan_depth_image_create(&vulkan_depth_image_create_info);

    VkCommandBuffer command_buffer = tgg_vulkan_command_buffer_allocate(graphics_command_pool, VK_COMMAND_BUFFER_LEVEL_PRIMARY);
    tgg_vulkan_command_buffer_begin(command_buffer, VK_COMMAND_BUFFER_USAGE_ONE_TIME_SUBMIT_BIT, TG_NULL);
    tgg_vulkan_command_buffer_cmd_transition_depth_image_layout(command_buffer, depth_image_h, 0, 0, VK_IMAGE_LAYOUT_UNDEFINED, TG_VULKAN_COLOR_IMAGE_LAYOUT, VK_PIPELINE_STAGE_TOP_OF_PIPE_BIT, VK_PIPELINE_STAGE_TOP_OF_PIPE_BIT);
    tgg_vulkan_command_buffer_end_and_submit(command_buffer, &graphics_queue);
    tgg_vulkan_command_buffer_free(graphics_command_pool, command_buffer);
...
void tgg_depth_image_destroy(tg_depth_image_h depth_image_h)
{
    ...
    tgg_vulkan_depth_image_destroy(depth_image_h);

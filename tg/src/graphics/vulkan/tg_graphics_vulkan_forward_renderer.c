...
void tg_forward_renderer_internal_init_shading_pass(tg_forward_renderer_h forward_renderer_h)
{
    ...
    VkImageView p_image_views[2] = { forward_renderer_h->camera_h->render_target.color_attachment.image_view, forward_renderer_h->camera_h->render_target.depth_attachment.image_view };

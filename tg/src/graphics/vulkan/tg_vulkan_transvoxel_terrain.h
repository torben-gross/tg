...
#define TG_TRANSVOXEL_CELLS_PER_BLOCK_SIDE_WITH_PADDING     (TG_TRANSVOXEL_CELLS_PER_BLOCK_SIDE + TG_TRANSVOXEL_PADDING_PER_SIDE + TG_TRANSVOXEL_PADDING_PER_SIDE)
...
#define TG_TRANSVOXEL_VOXELS_PER_BLOCK_SIDE                 (TG_TRANSVOXEL_CELLS_PER_BLOCK_SIDE + 1)
#define TG_TRANSVOXEL_VOXELS_PER_BLOCK_SIDE_WITH_PADDING    (TG_TRANSVOXEL_VOXELS_PER_BLOCK_SIDE + TG_TRANSVOXEL_PADDING_PER_SIDE + TG_TRANSVOXEL_PADDING_PER_SIDE)
...
#define TG_TRANSVOXEL_OCTREE_STRIDE_IN_CELLS                (TG_TRANSVOXEL_CELLS_PER_BLOCK_SIDE * TG_TRANSVOXEL_CELLS_PER_BLOCK_SIDE)
#define TG_TRANSVOXEL_OCTREE_STRIDE_IN_CELLS_WITH_PADDING   (TG_TRANSVOXEL_OCTREE_STRIDE_IN_CELLS + 2 * TG_TRANSVOXEL_PADDING_PER_SIDE)
#define TG_TRANSVOXEL_OCTREE_STRIDE_IN_VOXELS               (TG_TRANSVOXEL_OCTREE_STRIDE_IN_CELLS + 1)
#define TG_TRANSVOXEL_OCTREE_STRIDE_IN_VOXELS_WITH_PADDING  (TG_TRANSVOXEL_OCTREE_STRIDE_IN_VOXELS + 2 * TG_TRANSVOXEL_PADDING_PER_SIDE)

#define TG_TRANSVOXEL_VOXEL_MAP_VOXELS                      (TG_TRANSVOXEL_OCTREE_STRIDE_IN_VOXELS_WITH_PADDING * TG_TRANSVOXEL_OCTREE_STRIDE_IN_VOXELS_WITH_PADDING * TG_TRANSVOXEL_OCTREE_STRIDE_IN_VOXELS_WITH_PADDING)
#define TG_TRANSVOXEL_VOXEL_MAP_AT(voxel_map, x, y, z)      ((voxel_map)[TG_TRANSVOXEL_OCTREE_STRIDE_IN_VOXELS_WITH_PADDING * TG_TRANSVOXEL_OCTREE_STRIDE_IN_VOXELS_WITH_PADDING * (z) + TG_TRANSVOXEL_OCTREE_STRIDE_IN_VOXELS_WITH_PADDING * (y) + (x)])
#define TG_TRANSVOXEL_VOXEL_MAP_AT_V3(voxel_map, v)         TG_TRANSVOXEL_VOXEL_MAP_AT(voxel_map, (v).x, (v).y, (v).z)


#define TG_TRANSVOXEL_LOD_COUNT                             5

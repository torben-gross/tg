...
void tg_deferred_renderer_internal_init_shading_pass(tg_deferred_renderer_h deferred_renderer_h, u32 point_light_count, const tg_point_light* p_point_lights)
{
    ...
    deferred_renderer_h->shading_pass.exposure.vertex_shader = tg_vulkan_shader_module_create("shaders/adapt_exposure.vert");
    deferred_renderer_h->shading_pass.exposure.fragment_shader = tg_vulkan_shader_module_create("shaders/adapt_exposure.frag");
    ...
    {
        exposure_vulkan_graphics_pipeline_create_info.vertex_shader = deferred_renderer_h->shading_pass.exposure.vertex_shader;
        exposure_vulkan_graphics_pipeline_create_info.fragment_shader = deferred_renderer_h->shading_pass.exposure.fragment_shader;
...
void tg_deferred_renderer_end(tg_deferred_renderer_h deferred_renderer_h)
{
    ...
    VK_CALL(vkQueueSubmit(graphics_queue.queue, 1, &shading_submit_info, deferred_renderer_h->camera_h->render_target.fence));
}
